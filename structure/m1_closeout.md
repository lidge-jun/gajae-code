...
| 밴드 | 내용 | 상태 | struct_har |
|---|---|---|---|
| 100 | Node 셰임·sqlite·stream 테스트 | ✅ **완료 (260613)** — `dist-node/`+`src/shims/`, SDK import·스트리밍 green, 감사 라운드 1-4 통과(path traversal·TLS 보안 포함, `0debe38b`) (`2e9efc59`…`fba5cd56`) | [100_node](../struct_har/jwc_patched/100_node/), [packages_overview.md](./packages_overview.md) |
