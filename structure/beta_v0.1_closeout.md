...
> **범위**: OSS **문서/지도** 마감. M1 코드 게이트(99.01–99.12) 완료 선언은 [99.12](./m1_closeout.md) · [99.00.00 MOC](../devlog/_plan/260612_jawcode_fork/phase1/99.00.00_moc_stabilization.md)가 소유한다.

## 한줄

**jawcode(jwc)** 를 gajae-code fork 위의 JWC 제품 표면으로 설명하는 **삼축 문서**(structure · struct_har · chase)와 **레디니스 기준선**을 한 세트로 고정했다. 실행 진입은 [README.jwc.md](../README.jwc.md) · [doc_map.md](./doc_map.md).
...
| 99 결정·패키지·착수 순서 | [m1_closeout.md](./m1_closeout.md) ← [99.00.00](../devlog/_plan/260612_jawcode_fork/phase1/99.00.00_moc_stabilization.md) |
...
| jaw 릴리즈 노트 (jwc) | 미작성 — upstream `CHANGELOG` 계보 상속 |

## OSS 표면 (현재)

| 자산 | 상태 |
|------|------|
| [LICENSE](../LICENSE) | MIT (upstream 계보 상속) |
| [README.md](../README.md) | **jwc** 제품 설명 |
| [README.jwc.md](../README.jwc.md) | **jwc** 포크·로드맵·문서 링크 |
| [NOTICE.md](../NOTICE.md) | 계보·속성 |
| `.github/workflows` | CI (upstream monorepo 계보) |
| jaw 전용 CONTRIBUTING | [CONTRIBUTING.jwc.md](../CONTRIBUTING.jwc.md) (beta 스텁) · 상세는 AGENTS.md + structure/conventions |

공개 **명령/상태 경로**는 `jwc` · `.jwc/` 기준이다. 내부 워크스페이스 스코프 `@gajae-code/*`는 upstream 계보와 리베이스 경계를 위해 보존한다([D4](./gitstructure.md)).

## 착수 순서 (단일 정본)

**99.00.00** · **jwc_readiness** · **m1_closeout** · **chase/006_jwc_own_backlog** 는 아래 한 줄만 쓴다:
...
- chase 갭 → `struct_har/chase/002_gap_inventory.md` + 해당 `bands/`
