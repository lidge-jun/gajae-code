...
| 2 | [codex_transport.md](./codex_transport.md) | Codex WS/SSE 전송·프리워밍·워치독 floor·레이트리밋 텔레메트리·전송 가시성 | `packages/ai/src/providers/openai-codex-responses.ts:1` |
...
| [codex_transport.md](./codex_transport.md) | Codex WS/SSE·프리워밍·워치독·레이트리밋·전송 가시성 | codex, websocket, prewarm, watchdog, rate-limit |
