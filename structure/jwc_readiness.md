...
- **100** Node 포팅: ✅ **완료** — `dist-node/` esbuild 번들 + `src/shims/`(Bun→Node 셰임), Node 22 SDK import·createAgentSession·스트리밍 green, 적대 감사 라운드 1-5 통과(보안: path traversal·archive mtime·serve TLS/disconnect·PK-tar misroute 포함, `0debe38b`·`40a4a2f0`). [packages_overview.md](./packages_overview.md) M2 행·[100_moc_node_porting.md](../devlog/_plan/260612_jawcode_fork/100_moc_node_porting.md) · 커밋 `2e9efc59`…`fba5cd56`, closeout `fdb8d41d`
