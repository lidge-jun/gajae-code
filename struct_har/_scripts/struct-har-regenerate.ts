...
const BANDS: BandDef[] = [
	...
	},
	{
		...
		jwcAnchors: [
			"packages/coding-agent/src/defaults/gjc-defaults.ts",
			"packages/coding-agent/src/extensibility/skills.ts",
			"packages/coding-agent/src/gjc-runtime/cli-jaw-vocab.ts",
		],
	...
	},
	{
		...
		jwcAnchors: [
			"packages/coding-agent/src/defaults/gjc/skills/jaw-interview/SKILL.md",
			"packages/coding-agent/src/defaults/gjc-defaults.ts",
	...
	},
	{
		...
		jwcAnchors: [
			"packages/coding-agent/src/defaults/gjc/skills/ralplan/SKILL.md",
			"packages/coding-agent/src/gjc-runtime/orchestrate-runtime.ts",
			"packages/coding-agent/src/prompts/jaw/orchestrate-d.md",
			"structure/051_design_command_port.md",
		],
	...
	},
	{
		...
		jwcAnchors: [
			"packages/coding-agent/src/defaults/gjc/skills/ultragoal/SKILL.md",
			"packages/coding-agent/src/gjc-runtime/goal-runtime.ts",
