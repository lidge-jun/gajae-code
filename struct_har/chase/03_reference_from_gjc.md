...
> **플랜 정본**: [10_gjc_chase_MOC](./10_gjc_chase_MOC.md) · `10.001`–`10.006` (+ `10.007`…) · 완료 [_legacy/10](./_legacy/10/README.md)
> **정본 클론**: `devlog/_upstream_gjc/` · remote `Yeachan-Heo/gajae-code`  
...
| 4 | 이식 후 `struct_har` regen + chase [02_gap_inventory](./02_gap_inventory.md) 상태 갱신 |
...
| 참조 | 파일 | jaw 상태 |
|---|---|---|
| autocompact threshold | `modes/session/agent-session.ts` | HARD-EDIT + jaw TUI |
