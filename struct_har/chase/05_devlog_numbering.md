...
> - 횡단 표·bands: `02_gap_inventory` · `bands/` · `03`/`04`
...
| 4 | [02_gap_inventory](./02_gap_inventory.md) · `bands/` |
| 5 | (선택) devlog `_legacy/chase/`에 동일 복사 — **필수 아님** |

## 신규 NNN

1. MOC 다음 번호 (`10.007` …)
2. `struct_har/chase/10.007_<slug>.md` 생성
3. MOC 표 1행

## G3/G4

99·M2 자체 백로그 → [04_jwc_own_backlog](./04_jwc_own_backlog.md) (10/20 아님)