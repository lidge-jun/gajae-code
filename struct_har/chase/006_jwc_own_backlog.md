...
> gjc/omp가 아니라 **jawcode가 스스로 아직 안 닫은 것**. 정본: 99 MOC · [status](../../structure/status.md).
...
| 3 | check:schemas + biome | 99.02 | [99.02.00](../../devlog/_plan/260612_jawcode_fork/phase1/99.02.00_plan_parallel_landing.md) · [status](../../structure/status.md) |
...
착수 순서: `99.01 → 99.02 → 99.03 → 99.04 → 99.05 → 99.06 → 99.07` ([99.00.00](../../devlog/_plan/260612_jawcode_fork/phase1/99.00.00_moc_stabilization.md) · [status](../../structure/status.md)).
...
| OSS v0.1 | LICENSE·릴리즈·CONTRIBUTING | [status](../../structure/status.md) |
