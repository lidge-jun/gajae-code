...
> **정본 클론**: `devlog/_upstream_omp/` · `e13ad3805`  
> **역할**: 벤치·아키텍처 선행 참고 — **fork diff 한쪽이 아님** ([omp_origin/README.md](../omp_origin/README.md)).

## 원칙

1. omp → jwc **직행 이식 금지** (스코프·브랜딩·워크플로 상이).
2. 참조 = **읽기·대조·MOC 결정** — 코드 복붙 전 [05_interview_conclusions](../../devlog/_plan/260612_jawcode_fork/05_interview_conclusions.md) · D4.
...
→ [02_gap_inventory](./02_gap_inventory.md) G2 열 · omp HEAD in INDEX.