...
- 완료 → [_legacy/10|20](./_legacy/README.md) · [05](./05_devlog_numbering.md)
...
| 종류 | 설명 | chase 문서 |
|---|---|---|
| **G1 gjc drift** | gajae-code 클론이 jaw worktree보다 **앞선 커밋/기능** (버그픽스·provider·세션) | [03_reference_from_gjc.md](./03_reference_from_gjc.md) |
| **G2 omp bench** | 도구/LSP/catalog/worker 등 **omp만 두꺼운** 축 | [04_reference_from_omp.md](./04_reference_from_omp.md) |
| **G3 jwc product** | orchestrate discovery·memory CLI·HUD 등 **99/M1** | [04_jwc_own_backlog.md](./04_jwc_own_backlog.md) |
| **G4 platform** | M2 Node·cli-jaw 임베드·릴리즈 게이트 | [04_jwc_own_backlog.md](./04_jwc_own_backlog.md) §M2 |
...
1. [02_gap_inventory.md](./02_gap_inventory.md)
2. 막히는 밴드 → [bands/](./bands/) 해당 md
3. gjc 따라잡기 → [03_reference_from_gjc.md](./03_reference_from_gjc.md)
4. omp 벤치 → [04_reference_from_omp.md](./04_reference_from_omp.md)