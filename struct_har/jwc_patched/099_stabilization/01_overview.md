...
> 정본 MOC: [99.00.00_moc_stabilization.md](../../../devlog/_plan/260612_jawcode_fork/99.00.00_moc_stabilization.md)

## 레디니스 (99.00.01, 260612)

| MLB | 의미 |
|---:|---|
| **50** | 지금 — 코딩 보조 ⭕, pabcd 자율 ❌, memory CLI 마감 중 🟡 |
...
| GG | 패키지 | 상태 |
|---|---|---|
| 99.01 | memory CLI | **구현 중** (99.01.03) |
| 99.02 | 병렬 랜딩·CI (구 99.04) | 플랜 ✅ / 마감 ⬜ — schemas+biome+docs |
| 99.03 | pabcd discovery + 표면 re-facing (구 99.02) | [99.03.01](../../../devlog/_plan/260612_jawcode_fork/99.03.01_impl_workflow_surface.md) **독립 감사 PASS v2** — **구현 착수 가능** (99.02 선행) |
...
1. **pabcd discovery 0** — `system-prompt.md`에 orchestrate 미노출 → **99.03 M1/M2/M3**
2. **`jwc memory *` CLI 마감** → **99.01** (🟡 어댑터·명령 존재)
3. **check:schemas + biome** → **99.02** (CI only)

## M2 / 100 밴드 (참고)

- 로드맵: **000–099 = M1**, **100~ = M2** cli-jaw 상주 — [000_roadmap.md](../../../devlog/_plan/260612_jawcode_fork/000_roadmap.md)
