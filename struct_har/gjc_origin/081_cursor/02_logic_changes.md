# 081_cursor — 02 logic changes (gjc_origin)

> gjc_origin: upstream **기준 동작** (변경 전). 클론 @ `75d103f45145`.

## upstream 기준 동작

- cursor provider·tool-call upstream 동작 (pin/execute 이슈 포크에서 수정).

## fork에서 바뀐 점

→ [jwc_patched/081_cursor/02_logic_changes.md](../../jwc_patched/081_cursor/02_logic_changes.md)
