# 070_memory — 02 logic changes (gjc_origin)

> gjc_origin: upstream **기준 동작** (변경 전). 클론 @ `67427c6`.

## upstream 기준 동작

- gjc memories: startup·`memory_summary.md` 주입 (upstream과 동일 계열).

## fork에서 바뀐 점

→ [jwc_patched/070_memory/02_logic_changes.md](../../jwc_patched/070_memory/02_logic_changes.md)
