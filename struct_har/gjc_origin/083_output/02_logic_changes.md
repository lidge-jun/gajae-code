# 083_output — 02 logic changes (gjc_origin)

> gjc_origin: upstream **기준 동작** (변경 전). 클론 @ `75d103f45145`.

## upstream 기준 동작

- 도구 블록·spacing upstream (PR #520–523 대상).

## fork에서 바뀐 점

→ [jwc_patched/083_output/02_logic_changes.md](../../jwc_patched/083_output/02_logic_changes.md)
