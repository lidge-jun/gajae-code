# 010_shell — 02 logic changes (gjc_origin)

> gjc_origin: upstream **기준 동작** (변경 전). 클론 @ `75d103f45145`.

## upstream 기준 동작

- 사용자 CLI: `gjc` (`packages/gajae-code` npm wrapper).
- 설정·캐시: `~/.gjc/`, 프로젝트 `.gjc/` (표면).
- `APP_NAME` 기본 gjc 계열.

## fork에서 바뀐 점

→ [jwc_patched/010_shell/02_logic_changes.md](../../jwc_patched/010_shell/02_logic_changes.md)
