# 100_node — 02 logic changes (gjc_origin)

> gjc_origin: upstream **기준 동작** (변경 전). 클론 @ `75d103f45145`.

## upstream 기준 동작

- Bun 런타임 (gjc·jwc 공통 M1). Node 포팅은 M2.

## fork에서 바뀐 점

→ [jwc_patched/100_node/02_logic_changes.md](../../jwc_patched/100_node/02_logic_changes.md)
