...
| # | path | status |
|---:|---|---|
| 1 | `packages/coding-agent/src/defaults` | missing (verify clone) |
| 2 | `docs/` | present |

## diff (예)

```bash
diff -u devlog/_upstream_omp/packages/coding-agent/src/defaults devlog/_upstream_gjc/packages/coding-agent/src/defaults | head
```
