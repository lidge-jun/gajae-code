# 030_skills — 03 devlog refs (omp_origin)

> jaw MOC: `030_moc_skills_discovery.md` — omp는 **참조축**이므로 플랜은 jaw 착수/대조용.

## 플랜 (prefix 030)

- [030_moc_skills_discovery.md](../../../devlog/_plan/260612_jawcode_fork/030_moc_skills_discovery.md)
