# 050_plan — 03 devlog refs (omp_origin)

> jaw MOC: `050_moc_plan_pabcd.md` — omp는 **참조축**이므로 플랜은 jaw 착수/대조용.

## 플랜 (prefix 050)

- [050_moc_plan_pabcd.md](../../../devlog/_plan/260612_jawcode_fork/050_moc_plan_pabcd.md)
