# 081_cursor — 02 code facts (omp_origin)
...
```bash
diff -u devlog/_upstream_omp/packages/ai/src/providers/cursor.ts devlog/_upstream_gjc/packages/ai/src/providers/cursor.ts | head
```
