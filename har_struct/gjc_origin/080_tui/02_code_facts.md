...
> MOC 보조: `devlog/_plan/260612_jawcode_fork/080_moc_*.md`

## 1. upstream 경로 인벤토리 (`devlog/_upstream_gjc/`)

| # | upstream path | line | excerpt |
|---:|---|---:|---|
| — | `devlog/_upstream_gjc/packages/tui/src/modes/theme/theme.ts` | — | *(missing in clone)* |
| — | `devlog/_upstream_gjc/packages/tui/src/modes/components/welcome.ts` | — | *(missing in clone)* |
...
- MOC: `devlog/_plan/260612_jawcode_fork/080_moc_*`
