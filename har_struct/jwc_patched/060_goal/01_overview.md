# 060_goal — Goal / ultragoal 병합 (jwc_patched)
...
# 060_goal — Goal (ultragoal) (jwc_patched)

**⬜ MOC** — D3에 따라 cli-jaw `jwc goal set/update/...` 표면과 gjc ultragoal 엔진 병합 예정.

- 표면: D10 cli-jaw 통일
- 엔진: gjc ultragoal 재사용
...
- **밴드 `060_goal`** · side `jwc_patched` · 갱신 규칙: jwc_patched 선행 → gjc_origin HEAD
