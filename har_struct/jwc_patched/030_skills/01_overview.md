# 030_skills — 스킬 디스커버리 3계층 (jwc_patched)

> **MOC 정본**: `devlog/_plan/260612_jawcode_fork/030_moc_skills_discovery.md`
...
- **밴드 `030_skills`** · side `jwc_patched` · 갱신 규칙: jwc_patched 선행 → gjc_origin HEAD
