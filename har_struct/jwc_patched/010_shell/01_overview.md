# 010_shell — jwc 셸 + 표면 리네이밍 (jwc_patched)

> **MOC 정본**: `devlog/_plan/260612_jawcode_fork/010_moc_shell_rename.md`
...
|---|---|---|
| 1 | bin `gjc`,`gjc-stats` only | bin jwc+gjc |
| 2 | no packages/jwc | packages/jwc wrapper |
| 3 | APP_NAME=gjc | README.jwc.md |
| 4 | README upstream 단일 | rebrand allows jwc |
...
- **밴드 `010_shell`** · side `jwc_patched` · 갱신 규칙: jwc_patched 선행 → gjc_origin HEAD
