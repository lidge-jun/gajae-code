...
> ⚠️ **STALE (260612)**: 이 스냅샷 트리는 하드 수정 원칙 전환(085.5 개정·095) 이전 기준이다. diff-0/무수정 서술은 구원칙 기록 — **Phase β(.gjc→.jwc 경로 대전환, 069.1 P11) 완료 후 1회 재생성** (069.2 P8 순서 조정 — β가 스냅샷을 즉시 재-stale시키므로 W3 후 재생성 계획을 흡수·대체).
