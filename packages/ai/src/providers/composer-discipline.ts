/**
 * jwc fork: anchor/edit discipline for grok-composer-* models (devlog 081.8).
 *
 * Composer models are trained on a proprietary harness (Cursor / Grok Build)
 * and carry habits that break this agent's hashline edit workflow when served
 * through a generic provider. Observed in live sessions:
 *
 ...
 *    2-char anchor hash the edit tool requires (e.g. guessed "617hp" where the
 *    file had "617ca" → "Edit rejected: N anchors do not match");
 ...
 * system prompt. It is the openai-compat / cursor-RPC sibling of progrok's
 * TOOL_DISCIPLINE injection and complements CURSOR_HOST_OVERRIDE_PROMPT.
 */
