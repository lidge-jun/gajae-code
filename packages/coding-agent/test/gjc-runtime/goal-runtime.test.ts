...
import { GOAL_PLAN_PENDING_BRIEF, runNativeGoalCommand } from "../../src/gjc-runtime/goal-runtime";
import { readUltragoalLedger, readUltragoalPlan } from "../../src/gjc-runtime/ultragoal-runtime";
...
describe("jwc goal adapter (060/061)", () => {
	...
	it("plan → refine switches the pending sentinel to a direct objective", async () => {
		...
		expect(plan?.gjcObjective).toBe("ship the onboarding wizard v2");
