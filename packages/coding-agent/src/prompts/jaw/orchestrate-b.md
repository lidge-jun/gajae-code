...
Steps:
1. Re-read the approved plan (`plan_ref` devlog file and `.gjc/plans/ralplan/<run-id>/pending-approval.md`). Before any numeric, path, resource-id, or destructive value, compare your intended value against the plan.
