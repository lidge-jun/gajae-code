...
export default class Setup extends Command {
	...
	static flags = {
		...
		"jwc-command": Flags.string({ description: `Command used to start \`${APP_NAME} mcp-serve coordinator\`` }),
		"gjc-command": Flags.string({ description: "Deprecated alias of --jwc-command" }),
