...
export const WORKFLOW_COMMAND_REF_BLOCKS: readonly CommandRefBlock[] = [
	...
	},
	{
		...
		aliasesAndBridges: [
			{ from: "ralplan", to: "team|ultragoal", rendered: "jwc state ralplan handoff --to <team|ultragoal> --json" },
		],
		notes: [
		...
		aliasesAndBridges: [
			{
				...
				rendered: "jwc state ultragoal handoff --to <ralplan|jaw-interview> --json",
			},
		],
		notes: [
		...
		aliasesAndBridges: [
			{
				...
				rendered: "jwc state team handoff --to <ralplan|jaw-interview|ultragoal> --json",
			},
		],
		notes: [
