---
name: web-ai
description: Drive AI provider websites (ChatGPT, Gemini, Grok) via agbrowse — prompt envelopes, model selection, file upload, polling.
hide: true
---

# web-ai

Use this skill when driving AI provider websites through the `agbrowse` Chrome/CDP runtime.
