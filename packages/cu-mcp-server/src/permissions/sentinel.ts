import { SHELL_SENTINELS, FILESYSTEM_SENTINELS, SYSTEM_SETTINGS_SENTINELS } from "../safety/bundleIds.js";
...
export function formatSentinelWarning(warning: SentinelWarning): string {
  switch (warning) {
    case "shell": return "⚠ This app provides shell access (equivalent to full system control)";
    case "filesystem": return "⚠ This app provides filesystem access";
    case "system_settings": return "⚠ This app can modify system settings";
  }
}
