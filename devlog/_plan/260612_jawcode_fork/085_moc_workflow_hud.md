...
| [085.5](./085.5_plan_prompt_rebrand.md) | **프롬프트 gjc→jaw 전환** — 전수조사(직원 2갈래) + 3레이어 런타임 치환 설계 + **기능 버그**(role-agent bash allowlist의 jwc 불능) | 독립 — M1(기능 수정)은 즉시 착수 가능 |
...
구현 순서: **085.5-M1(기능 버그) ∥ 085.4(인프라) → 085.1(띠) → 085.3(goal) → 085.2(게이지 보강) → 085.5-M2~M5(브랜드 치환, 085.6-M2 동행)**. 085.4+085.1이 시각화 M1. 085.6-M1(헬퍼)은 독립 — 즉시 착수 가능.
