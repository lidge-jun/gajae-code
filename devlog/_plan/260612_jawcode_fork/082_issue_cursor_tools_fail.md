# 082 — issue: cursor "도구 전체 실패" 증상 (title-generator 환각)
...
> 소속: 080 밴드 (발현 표면 = TUI 세션 타이틀). 자매 이슈: [081](./081_issue_tui_toolcall_render.md)·[083](./083_issue_cursor_exec_unbound.md) — 셋 다 **별개 원인**.
> 주의: 본 이슈(타이틀 환각)는 "도구가 실패한 것처럼 보인" 표면일 뿐이고, **실제 도구 실행이 안 되던
> 근본 원인은 [083](./083_issue_cursor_exec_unbound.md)(exec 핸들러 unbound this)**다. 081 렌더 수정 후 드러남.
